...
import styles from "../../styles/modules/ui/logo.module.css"
      ...
      <g id="g2892" style={{ fill: theme }}>
        ...
        >
          ...
          <g
            ...
            style={{ fill: theme }}
          >
            <g id="g52-1-0" style={{ fill: theme }}>
              <path
                id="rect50-4-8"
                style={{ strokeWidth: 0.999978, fill: theme }}
        ...
        >
          ...
          <g
            ...
            style={{ fill: theme }}
          >
            <g id="g52-1-07" style={{ fill: theme }}>
              <path
                id="rect50-4-6"
                transform="matrix(0.866,-0.5,0.5,0.866,-145.888,110.1181)"
                d="m 118.42,311.75601 h 28.226 v 31.052 H 118.42 Z"
          ...
          <g
            ...
            style={{ fill: theme }}
          >
            <g id="g40-7-5-2" style={{ fill: theme }}>
              <path
                id="rect38-6-3-2"
                transform="matrix(0.866,-0.5,0.5,0.866,-163.1138,92.8945)"
                d="M 77.668999,335.289 H 105.895 v 31.052 H 77.668999 Z"
          ...
          <g
            ...
            style={{ fill: theme }}
          >
            <g id="g52-1-0-2" style={{ fill: theme }}>
              <path
                id="rect50-4-8-2"
                style={{ strokeWidth: 0.999978, fill: theme }}
                transform="rotate(-30.000728)"
        ...
        >
          ...
          <g
            ...
            style={{ fill: theme }}
          >
            <g id="g40-7-3-7" style={{ fill: theme }}>
              <path
                id="rect38-6-7-4"
                transform="matrix(0.866,-0.5,0.5,0.866,-163.1138,92.8945)"
                d="M 77.668999,335.289 H 105.895 v 31.052 H 77.668999 Z"
          ...
          <g
            ...
            style={{ fill: theme }}
          >
            <g id="g52-1-07-4" style={{ fill: theme }}>
              <path
                id="rect50-4-6-8"
                transform="matrix(0.866,-0.5,0.5,0.866,-145.888,110.1181)"
                d="m 118.42,311.75601 h 28.226 v 31.052 H 118.42 Z"
          ...
          <g
            ...
            style={{ fill: theme }}
          >
            <g id="g40-7-5-2-8" style={{ fill: theme }}>
              <path
                id="rect38-6-3-2-1"
                transform="matrix(0.866,-0.5,0.5,0.866,-163.1138,92.8945)"
                d="M 77.668999,335.289 H 105.895 v 31.052 H 77.668999 Z"
          ...
          <g
            ...
            style={{ fill: theme }}
          >
            <g id="g52-1-0-2-1" style={{ fill: theme }}>
              <path
                id="rect50-4-8-2-4"
                style={{ strokeWidth: 0.999978, fill: theme }}
                transform="rotate(-30.000728)"
